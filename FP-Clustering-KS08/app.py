...
def predict():
    ...
    return render_template('index.html', prediction_text = 'Berdasarkan nilai dari inputtan, maka orang tersebut berada pada cluster {} yang mana merupakan {}'.format(prediction,output[prediction]))
